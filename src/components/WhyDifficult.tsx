...
import { ArrowLeft, Layers, PenTool, Wrench, Settings } from 'lucide-react';
...
export function WhyDifficult() {
  ...
  return (
    <section className="w-full bg-brand-dark py-20 px-4 md:px-10 lg:px-20">
      <div className="max-w-[1200px] mx-auto bg-brand-black rounded-[20px] p-8 md:p-12 lg:p-16 border border-brand-dark">
        {/* Top Section */}
        <motion.div
          initial={{
            opacity: 0,
          ...
          <h2 className="font-heading font-bold text-3xl md:text-[40px] leading-tight text-white mb-6 max-w-3xl">
            {t('diff.title')}
          </h2>
